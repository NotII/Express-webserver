  ...
  for (var i of sharex) {
    if (req.hostname === i) {
      var file = fs.readFile("./image.html", { encoding: "utf-8" }, function (
        ...
        var Splash = Math.floor(Math.random() * splash.length);
